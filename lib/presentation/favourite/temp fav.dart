...
class _FavouriteItemState extends State<FavouriteItem> {
  ...
  // final _favFormKey = GlobalKey<FormState>(debugLabel: "Favourite Item");
    ...
    return Scaffold(
      ...
      body: NotificationListener<UserScrollNotification>(
        ...
        child: ListView(
            ...
            // physics: !authController.isLoggedIn.value ? NeverScrollableScrollPhysics() : ClampingScrollPhysics(),
            children: [
              Container(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                    ...
                                    style: AppTextStyle.txtPoppinsBold20.copyWith(fontFamily: 'Roboto-Regular')),
                              ),
                              Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      Share.share(
                              'http://54.205.120.230/blog/share/slug/${blogController.getBlogs.value[widget.index].slug}')
                          .then((value) async {
